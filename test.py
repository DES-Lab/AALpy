...
# dfa = get_Angluin_dfa()
dfa = generate_random_deterministic_automata('mealy', num_states=50, input_alphabet_size=2, output_alphabet_size=3,)
...
learned_model = run_Lstar(input_al, sul1, eq_oracle, automaton_type='mealy', cex_processing='rs',suffix_closedness=True,closedness_type='prefix',closing_strategy='single_longest',print_level=1)
