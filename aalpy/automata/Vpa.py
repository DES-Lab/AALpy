    ...
    def possible(self, letter):
        ...
        if letter is not None:
            ...
            for t in transitions:
                if t.letter in self.call_set:
                    possible_trans.append(t)
                elif t.letter in self.return_set:
    ...
    def step(self, letter):
        ...
        if letter is not None:
            ...
            if trans.action == 'push':
                ...
                if not self.stack:  # empty stack elem should always be there
                    self.current_state = Vpa.error_state
                    return False
                self.stack.pop()

        return self.current_state.is_accepting and not self.stack
