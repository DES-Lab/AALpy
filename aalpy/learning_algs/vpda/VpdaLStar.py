...
from ..deterministic.CounterExampleProcessing import longest_prefix_cex_processing, rs_cex_processing, \
    counterexample_successfully_processed
from .VpdaObservationTable import VpdaObservationTable
...
def run_vpda_Lstar(alphabet: list, sul: SUL, eq_oracle: Oracle, automaton_type, samples=None,
    ...
    observation_table = VpdaObservationTable(alphabet, sul, automaton_type, all_prefixes_in_obs_table)
