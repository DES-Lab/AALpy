...
def main():
    ...
    learned_dfa = run_KV(sul.alphabet, sul, eq_oracle, automaton_type='dfa', print_level=1, cex_processing=None)

    eq_oracle = RandomWalkEqOracle(sul.alphabet, sul, 1000)
    
    learned_dfa = run_Lstar(sul.alphabet, sul, eq_oracle, automaton_type='dfa', print_level=1, cex_processing="rs")
